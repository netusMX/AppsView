public class AppsView.Widgets.BlurBackground : Gtk.EventBox {
    ...
    public BlurBackground (string? path) {
        if (path == null) {
    ...
    public override bool draw (Cairo.Context cr) {
        ...
        var surface = new Granite.Drawing.BufferSurface ((int)width, (int)height);
        Gdk.cairo_set_source_pixbuf (surface.context, fitting_pixbuf, 0, 0);
        surface.context.paint ();
        surface.exponential_blur (70);
