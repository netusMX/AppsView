...
public class AppsView.Widgets.AppButton : Gtk.Button {
...
#endif
    private static AppContextMenu menu;

    private const int ICON_SIZE = 78;
    ...
    construct {
        ...
        style_context = app_label.get_style_context ();
    ...
    private bool create_context_menu (Gdk.Event e) {
        menu = new AppContextMenu (app.desktop_id, app.desktop_path);
